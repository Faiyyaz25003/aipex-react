  ...
  return (
    <div className="w-full min-h-[50vh] flex bg-white">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 sm:px-12 md:px-16 lg:px-20 py-8">
        ...
        <p className="text-gray-500 mb-6 text-base">{t("quoteSubtitle")}</p>
        ...
        <form className="space-y-5 w-full max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <option>{t("internationalShipping")}</option>
              <option>{t("liquidCourier")}</option>
              <option>{t("medicineShipping")}</option>
              <option>{t("dangerousGoods")}</option>
              <option>{t("universityDocuments")}</option>
              <option>{t("corporateGifting")}</option>
              <option>{t("warehousing")}</option>
              <option>{t("eventsLogistics")}</option>
              <option>{t("customClearing")}</option>
            </select>
          </div>
          ...
          {/* reCAPTCHA Placeholder */}
          <div className="flex flex-col items-left">
            <img src="Captcha.png" alt="Captcha" className="w-65 h-15" />
          </div>
        ...
        <div className="mt-8 text-gray-700 text-sm">
          ...
          <h3 className="font-bold text-lg mt-4">{t("alternately")}</h3>
          <p className="mt-2">
            {t("callWhatsapp")}{" "}
            <span className="text-blue-600 font-semibold">+91-90225-55633</span>
          </p>
